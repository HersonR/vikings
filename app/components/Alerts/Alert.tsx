...
type AlertType = "success" | "error" | "info" | "warning" | string;
...
const Alert: React.FC<AlertProps> = ({
  ...
  const getColor = () => {
    switch (type) {
      ...
      default:
        return "bg-gray-100 text-blue-add-ons";
    }
  };
  ...
  return (
    <motion.div
      ...
      exit={{ y: 50, opacity: 0 }}
      className={`fixed bottom-0 right-0 w-96 mb-10 mr-3 sm:mr-10 rounded-lg shadow-lg ${getColor()} p-4 transition-transform duration-300`}
      style={{
        zIndex: 1000,
